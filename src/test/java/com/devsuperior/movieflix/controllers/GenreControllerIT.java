...
public class GenreControllerIT {
	...
	// findAll deve retornar token não autorizado 401 Unauthorized quando não válido
	@Test
	...
	//findAll deve retornar todos os gêneros quando o visitante for autenticado
	@Test
	...
	// findAll deve retornar todos os gêneros quando o membro for autenticado
	@Test
